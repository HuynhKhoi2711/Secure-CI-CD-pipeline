...
Bạn Trường sẽ lo phần "chốt chặn" thứ hai trên GitHub. Khi code vượt qua được máy local và đẩy lên GitHub (Push/Pull Request), CI Pipeline sẽ quét sâu hơn vào mã nguồn và các thư viện phụ thuộc.
...
Thầy có thể hướng dẫn chi tiết hơn về cách viết file cấu hình cho công cụ nào trước. Em muốn thầy gợi ý file cấu hình `.pre-commit-config.yaml` cho em, hay đoạn mã YAML tích hợp Semgrep cho bạn Trường?
